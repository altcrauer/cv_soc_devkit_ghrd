...
create_system $qsys_name
    ...
    set_instance_parameter_value hps_0 DEFAULT_FAST_SIM_MODEL {1}
    ...
    set_instance_parameter_value hps_0 S2FCLK_USER0CLK_FREQ {50}
    ...
    set_instance_parameter_value sysid_qsys id {-1395322095}
